...
import { raceListReducer, singleRaceInfoReducer, startInfoReducer, resultInfoReducer, userLoginReducer, saveResultsReducer } from './reducers/simulatorReducers'
...
const reducer = combineReducers({
    ...
    saveResults: saveResultsReducer
})
